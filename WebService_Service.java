 ...
 * 
 */
@WebServiceClient(name = "webService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9090/ServidorRestApache/webService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/ServidorRestApache/webService?wsdl");
